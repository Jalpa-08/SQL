...
select * from bank_details where age=33 and marital= 'married';
select * from bank_details where age=40 and marital = 'single';
select * from bank_details where age=60 and job = 'retired';
select count(*) from bank_details where education ='unkhown' or marital ='single';
select * from bank_details where education ='unkhown' or marital='single' or balance<500;
select * from bank_details where education ='unkhown' or marital='married' or balance<500;
...
/* find person who have loan */
select * from bank_details where loan = 'yes';
/* find avg balancce whoes job role is admin */
select avg(balance) from bank_details where job='admin.';
/* find out record without job whoes age is below 45 */
select * from bank_details where job ='unemployed' and age<45;
/* find eduction is primary and jobless */
select * from bank_details where education="primary" and job = 'unemployed';
/* find record whoes balance is negative */
select * from bank_details where balance<0;
/* find out who is not having house along with their balance */
select balance,housing from bank_details where housing='no';
/* fatching full row of min balance */
select *, min(balance) from bank_details;
...
select * from cust;
select * from cust where age=(select min(age) from cust);